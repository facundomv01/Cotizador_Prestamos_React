  ...
  return (
    <div className="my-20 max-w-lg mx-auto bg-white shadow p-10">
      ...
      <div className="flex justify-between my-6" >
        <Button
          operador='-'
          fn={hadleClickDecremento}
        />
        <Button
          operador='+'
          fn={hadleClickIncremento}
        />
      </div>
      ...
      <select className="mt-5 w-full p-2 bg-white border border-gray-300 rounded-md text-center text-xl font-bold text-gray-500"
        value={meses}
